...
**v1 terminada:** cuando los siete requerimientos funcionales (RF-001 a RF-007) están implementados y funcionando. No hay condición adicional.
...
| RN-002 | **No hay escritura de datos de dominio por parte del usuario**, y por lo tanto no hay validaciones de negocio propias sobre ellos. La única preferencia que el usuario define es el tema (RF-007). |
